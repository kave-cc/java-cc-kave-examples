...
public class GettingStarted {
	...
	public void run() {
		 ...
		 */
		Set<String> userZips = findUserZips();
	 ...
	 */
	public Set<String> findUserZips() {
		return new Directory(eventsDir).findFiles(s -> s.endsWith(".zip"));
	}
	...
	private void process(IDEEvent e) {
		...
		if (e instanceof CommandEvent) {
			...
			/*
			 * CommandEvent and Completion event are just two examples, please
			 * explore the type hierarchy of IDEEvent to find other types and
			 * review their API to understand what kind of context data is
			 * available.
			 * 
			 * We include this "fall back" case, to show which basic information
			 * is always available.
			 */
			processBasic(e);
		}
